...
const Sidebar = React.memo((props: Props) => {
  const { publicKey, connectedMethods, connect, logsVisibility, toggleLogs } = props;
  ...
  return (
    <Main>
      <Body>
        <Menu>
          <MenuButton onClick={toggleSandboxMenu}>Experimental Sandbox {sandboxMenuOpen ? '-' : '\u2630'}</MenuButton>
          {sandboxMenuOpen && (
            <MenuContainer>
              ...
              <NavigationLink to="/deeplinks-sandbox">Deeplinks Sandbox</NavigationLink>
