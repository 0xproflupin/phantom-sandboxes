...
export const buildUrl = (path: string, params: URLSearchParams) => `https://phantom.app/ul/v1/${path}?${params.toString()}`;
...
export const setLocalStorage = (params: LocalStorageParams) => {
  ...
  if (params.phantomWalletPublicKey !== undefined) localStorage.setItem("phantomWalletPublicKey", params.phantomWalletPublicKey);
